...
## Sobre este lugar:![[mapa-principal(light) 1.png]]![[mapa-principal(background).png]]
![[mapa-principal.png]]Esta página es muy amplia y tiene muchos espacios explorables. Para que no se pierdan, acá les dejo escrito más o menos como pueden moverse. Para conocer lo que me gusta [[librería|leer]], o [[Música/index|escuchar]], o mis [[galería|fotos]] favoritas, visitá esas páginas. Lo que estoy viviendo [[ahora]]. Si preferis leerme en otro lado, acá tenés el [RSS](https://salvamir.github.io/index.xml). Y por si buscabas [[algo-mas|algo más]].... 
![[casadelvecino.jpg]]
