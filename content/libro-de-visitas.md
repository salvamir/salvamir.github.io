...
---
Esta es una página de interacciones. Acá paso cada tanto a ver quienes se cruzaron con mi blog y ver que piensan. Como para que no se sienta demasiado solitario. 
...
<p class="webmention-desc">Acá podés dejar el link a alguna nota o post particular de tu propia página web. De esta forma me hacés saber a mi que te llegó algo de lo que escribí y podemos conversar un poco.</p>
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  fetch(apiUrl)
    ...
    .catch(err => {
      ...
      listContainer.innerHTML = '<p class="wm-no-mentions">Parece que no hay ninguna respuesta.</p>';
    });
});
</script>